...
## [Unreleased](https://github.com/RCIC-UCI-Public/yaml2rpm/compare/2.5...HEAD)

### Commits

- One more %changelog warning squash [`f986013`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/f9860130bf20e64b6bbc29e2ae65f4c6120cd885)
- address more %changelog warnings [`f431064`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/f4310648c8d5972693238d6a3c2edcc369da3a6a)
- bin-python, python-future are not needed on Rocky 10. [`3272895`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/327289581ab531fc7ac474a40bfa32734922874e)
- Squash %changelog warnings for various bootstrap packages [`2e24936`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/2e249362bf226856021f9f319e038cb28166638a)
- Get rid of warning for no %changelog in spec file [`2fad49a`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/2fad49a2c3893a0bb63988b1037c34463f0953d1)
- Squash changelog warning for yamls that include rpm.yaml. [`8519b6b`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/8519b6be5bf00ad974254239fed940177f98f346)
- python setuptools/devel name change for Rocky 10. [`677b0e8`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/677b0e88ce1c5e44a6e24860813eb41976a018e3)
- Step 1 of yaml2rpm for Rocky 10. Still some debug. [`604ad74`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/604ad7442549a07801cd9b61ca157ad4781550e5)
- update size for yaml2rpm rpm [`500b304`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/500b304ffe2c8bf436b050b7d52a110f0e0afb0a)
- update rpms sizes [`550bd7d`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/550bd7d7904deda9d5933174797da81f73cc7187)
- update admixdb target: don't reduce rpm size in the dbfile. [`e1ab9d2`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/e1ab9d237b76de1e93b24e44f9ea236abd582be2)
- keep the current revision of yaml2rpm [`454fc3b`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/454fc3bfe7cef02ca914768a8b97a363d210df97)
- update site97.yaml with latest updatesd versions. [`3021a78`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/3021a78f369007e3cbae7763ef7fbede7d983f06)
- update release per changes in gen-definitinos.py [`8041aaa`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/8041aaaee3e34b82abc6228c9d4a932be22b155e)
- Clean spaces and comments. [`aa7ac6e`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/aa7ac6e78f2342cec87b2ab51e3c408d29c9b798)
- in python.314+ the multiprocessing.Pool has changed  its default start [`3ed1dcf`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/3ed1dcf192767b1663e271c4d4b56e1be4ad3fc3)
- update re.compile per SyntaxWarning from python 3.14+ [`f5eae3d`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/f5eae3dfc358da0bb2890a0354565ae24a254a7c)
- add site97.yaml for a newer OS. [`4436a29`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/4436a29c2a368ae6b30c6bb510c26b796c098acc)
- update rpmdb for rocky 9.7 [`4b5742a`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/4b5742afbc0361706afda98826302474408e1677)
- Like yaml2rpm, rcic-module-support needs to --dereference when tarring [`ba109bb`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/ba109bbee97fba131333d2b7035a44372217343e)
- add  admix expect3ed rpms sizes (round off last 2 digits) [`92a2025`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/92a2025262266c95fabe1fc566e9df4788098980)
- add target to check built rpms sizes [`2e4d420`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/2e4d42044b6d5bd9c5178af5b78346a965e2a7e3)
- use core-tiny for finding RPM [`3797446`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/3797446335dd44bb751730b34acc7b1460ceb7b5)
- add httpge.sh, needed for download   sources when building RPMS. [`9859a95`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/9859a9580eaa804d1f34d6e7b3f30f1fc656831d)
- ignore build stage directories [`0228deb`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/0228debed714b289bb33372e62c32a42d4037638)
- this needss to be done for all sets, got lost between updates [`b0a9b4c`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/b0a9b4cb66da4f3c944f676dce312c2c0ab53852)
- update module-info target to add  processing of 'system:' [`caad133`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/caad1336e2a66894b6a91cceaa8f30708b518ba8)
- make a small subset of rocks-devel core repo. [`c6d024c`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/c6d024cf941c75cd7d34c009dadb52a604cc82bd)
- With parallel build logic, the Modules directory becomes a link in the [`ef3daec`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/ef3daecf7f1fdb1a240756a1db0fa08c9644688c)
- version bump on yaml2rpm.. probably should set a new major and reset the [`c1ece4e`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/c1ece4e025e6581cff8c846bf80777ba15c88165)
- Support parallel package building (parallelpkgs target). [`7b3090b`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/7b3090b106db9fd475352cd3f2e0ea78c39900d2)
- add generation of csv-like table info for the modules in the admix [`e8a3b80`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/e8a3b800d4835060046d6de3f8485be12724b309)
- For manifiest, module-provides, .... [`3cb0609`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/3cb0609628db50e98eb158ac91ce0af13a2c52cb)
- Introduce concept of "Serial sets" -- these are "virtual sets" that have [`9b44a8e`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/9b44a8e4b12b8ea62e7620d7c65a5d9a86675611)
- missing fi for if statement [`07f16a6`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/07f16a601d70a6a40da39bf142c9f4a20a12d3f7)
- $( ) --&gt; ${ } [`645a3b2`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/645a3b2749e400e77d986c72f0ba1722cdb375ee)
- Use $(ADMIXROOT)/soources instead of ../sources [`6acaa12`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/6acaa127f586229e764471be6556b63ebfcf4815)
- Add feature to runparallel to automatically generate err and out [`8351217`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/8351217db57eae07816dff9ae8230d2e614dfb25)
- need a -s when calling  make [un]install-admix-exclusive target [`ab43bc7`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/ab43bc75ceef1f2f737ab74088c58b647c3ee88b)
- fix sed when more than 2 sets to be built [`9b162af`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/9b162af36a89bc0439012b9d664901d4a438cfc3)
- Create buildall-parallel target. [`bbd5bdc`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/bbd5bdc65b982d344580d3713ec8c914a46ea6ec)
- Enable concurrent builds of SETS in an admix. [`81186b1`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/81186b19672ec9748705638ecf0f9ebd6cd44082)
- test push [`f3a7fa4`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/f3a7fa4f9abc6d668317ae81c07a6c83a4caf221)
- update compilers, mkl, mpi, etc to the latest versions either provided [`3c9da81`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/3c9da8142a891052563004a2e2c65bc07d8728cb)
- add $(SET) to the name of the tmpbuild directory. [`ec23afd`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/ec23afdf80cc747af5b3650f86e722b9cb0bd6f5)
- add a '-' in /bin/rm ... for boostrapRepo target for the case where [`3262ce8`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/3262ce80fd0cf1925517a331f4960f96ed0de59e)
- Copy the created rocks-devel RPM (from the rocks core repo) into the [`802cf81`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/802cf815458e1387953d39cf155e6c4e724c262e)
- Speed up bootstrap for admixes (e.g. R, Perl, Python) that have large [`c5d209c`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/c5d209c650b129b4e0c3be0fa135da88120d79de)
- Add "stageset" definition (empty by default). Allows action to happen [`24ef058`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/24ef0587314b574a4130972229275b2660b803bc)
- Push base intel compiler version to 2024 for Rocky9. [`0d79b19`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/0d79b19479dc8f5857d06744b7e9d594bdc7ba14)
- Baseline Version Updates for 9 [`0b99942`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/0b9994220606d0ecbc436b6d302ddabb01a653c2)
- 1. wrap /usr/bin/strip for every rpm build. Odd behaviour of strip and this [`bb0c996`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/bb0c9968d4d95e883eb520f4010f745c7364e8cf)
- include generic versions.yaml into every yaml file to get admix name [`d687c20`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/d687c208ccb5a46aaa735044fae0bd56a3f1814c)

## [2.5](https://github.com/RCIC-UCI-Public/yaml2rpm/compare/2.0...2.5) - 2025-01-21

### Commits

- run auto-changelog before tagging [`b6d39a4`](https://github.com/RCIC-UCI-Public/yaml2rpm/commit/b6d39a4b57dabcffaf2c683a9ef128bc80eedd29)
